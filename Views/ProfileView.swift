...
struct ProfileView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showingEditProfile) {
            NavigationStack{
                EditProfileView(profile: $vm.profile, theme: theme, onSave: {vm.save()})
            }
           
        }
        .sheet(isPresented: $showingGoalsEditor) {
            NavigationStack{
                GoalsEditorView(goals: $vm.profile.goals, theme: theme, onSave: {vm.save()})
            }
        }
        .sheet(isPresented: $showingAllergiesEditor) {
            NavigationStack{
                AllergiesEditorView(allergies: $vm.profile.allergies, theme: theme, onSave: {vm.save()})
            }
        }
    }
